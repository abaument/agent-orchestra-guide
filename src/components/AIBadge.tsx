...
const AIBadge = () => {
  ...
  return (
    <div className="ai-badge flex items-center bg-blue-50 rounded-md px-2 py-1 text-xs text-gray-600 max-w-fit mt-2">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild>
          <button className="ml-1 text-electric-blue hover:bg-blue-100 rounded-full p-1" onClick={() => setOpen(true)}>
            <Info size={14} />
          </button>
        </DialogTrigger>
